...
| `intuitionistic-logic/soundness-completeness/soundness-nd.tex`: semantic validity of elementary rules and intuitionistic ND soundness | `LO.IntProp.Formula.Kripke.ValidOnModel.andElim₁`, `andElim₂`, `andInst₃`, `orInst₁`, `orInst₂`, `orElim`, `imply₁`, `imply₂`, `mdp`, `efq` and frame variants | Existing semantic lemmas plus `IntuitionisticDerivation`, `toDerivation`, `derivation_sound`, and `proof_sound` | Native semantic and derivation chain; checked. Completeness remains pending. |
...
| `normal-modal-logic` relational semantics and K/T/D/4/B/5 frame facts | Historical `LO.Modal.Formula`, `LO.Modal.Kripke.Frame`, `LO.Modal.Kripke.Model`, `LO.Modal.Formula.Kripke.Satisfies`, `LO.Axioms.K/T/D/Four`, `ValidOnModel.axiomK`, `ValidOnFrame.axiomK`, `ValidOnModel.nec`, `ValidOnFrame.nec`, `LO.Modal.Kripke.reflexive_of_validate_AxiomT`, and `transitive_of_validate_AxiomFour` declarations | `FormalOLP.NormalModalLogic` syntax, models, forcing, and K/T/D/4/B/5 correspondence declarations | Native theorem chain; checked. Hilbert completeness remains pending. |
